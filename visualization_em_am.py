...
#     save_path = f"plot/em_series/plot_out_iter_{out_iter}_iter_{in_iter}_{step}.png"
#     # save_path = f"plot/em_series_fail/plot_out_iter_{out_iter}_iter_{in_iter}_{step}.png"
...
#     in_iter = entry["in_iter"]
#     out_iter =entry["out_iter"]
#     save_path = f"plot/am_series/plot_out_iter_{out_iter}_iter_{in_iter}_{step}.png"
#     # save_path = f"plot/am_series_control/plot_out_iter_{out_iter}_iter_{in_iter}_{step}.png"
...
sigma2_Z = 1e-1
max_out_iter, max_in_iter = 2, 50

# Generate noisy observation
y_obs = generate_noisy_obs(X_true, C, sigma2_Z, N)

print("Starting EM Algorithm")
# R_est_em, X_est_em , X_est_vis, _, _= expectation_maximization(sigma2_Z, N, y_obs, max_out_iter, max_in_iter, R_true, X_true)
